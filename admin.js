...
function buildPageDocument(html, css, imageUrls) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><style>' +
    ...
    '.redaction{display:inline-block;background:#8b0000;color:transparent;border-radius:2px;padding:0 0.5ch;line-height:1em}.redaction[aria-hidden="true"]::after{content:"";display:inline-block;width:0.6em;height:1em;background:#8b0000;border-radius:inherit}' +
